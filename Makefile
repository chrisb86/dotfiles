...
deploy-duti: ## Deploy duti config
	@echo "\033[32m>>>\033[0m Deploy duti config to ${HOMEDIR}/.config/duti"
	@mkdir -p ${HOMEDIR}/.config/duti
	@cp .config/duti/* ${HOMEDIR}/.config/duti
	@echo "\033[32m>>>\033[0m Processing duti config from ${HOMEDIR}/.config/duti"
...
deploy-brewfile: ## Deploy Brewfile
	@echo "\033[32m>>>\033[0m Deploy Brewfile to ${HOMEDIR}/.config/"
	@mkdir -p ${HOMEDIR}/.config
	@cp .config/Brewfile ${HOMEDIR}/.config/

deploy-ssh: ## Deploy SSH config
	@echo "\033[32m>>>\033[0m Deploy SSH config to ${HOMEDIR}/.ssh"
